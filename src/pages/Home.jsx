...
const therapies = [
  {
    "name": "Hydrotherapy – Baths & Packs",
    "category": "Naturopathy",
    "image": "hydrotherapy",
    "tag": "WATER-BASED CARE",
    "description": "Baths and packs, selected with the centre’s team.",
    "detail": "Baths and packs, selected with the centre’s team. See the current catalogue for printed rates and booking options."
  },
  {
    ...
    "image": "ayurveda",
    "tag": "TIME TO UNWIND",
    "description": "Full-body massage, with your comfort at the centre.",
    "detail": "Full-body massage, with your comfort at the centre. See the current catalogue for printed rates and booking options."
  },
  {
    "name": "Acupuncture",
    "category": "Naturopathy",
    "image": "acupuncture",
    "tag": "INDIVIDUAL CARE",
    "description": "Discuss acupuncture and its suitability with your practitioner.",
    "detail": "Discuss acupuncture and its suitability with your practitioner. See the current catalogue for printed rates and booking options."
  },
  {
    "name": "Steam & Fomentation",
    "category": "Naturopathy",
    "image": "sauna",
    "tag": "WARMTH & REST",
    "description": "Heat-based care, guided by the treatment team.",
    "detail": "Heat-based care, guided by the treatment team. See the current catalogue for printed rates and booking options."
  },
  {
    "name": "Shirodhara",
    "category": "Body therapies",
    "image": "ayurveda",
    "tag": "A QUIET MOMENT",
    "description": "Contact the centre to discuss the two treatment options listed in the brochure.",
    "detail": "Contact the centre to discuss the two treatment options listed in the brochure. See the current catalogue for printed rates and booking options."
  },
  {
    "name": "Mud Therapy Packs",
    "category": "Naturopathy",
    "image": "hydrotherapy",
    "tag": "EARTH & REST",
    "description": "Explore the mud therapy packs offered at the centre.",
    "detail": "Explore the mud therapy packs offered at the centre. See the current catalogue for printed rates and booking options."
  },
  {
    ...
    "image": "consultation",
    "tag": "YOUR FIRST STEP",
    "description": "Meet the team to discuss your history, needs and treatment plan.",
    "detail": "Meet the team to discuss your history, needs and treatment plan. See the current catalogue for printed rates and booking options."
  }
];
const additionalTherapies = [
  {
    "name": "Enema",
    "tag": "FROM OUR BROCHURE",
    "detail": "Listed in the centre’s printed treatment catalogue. View rates and contact the team to discuss the appropriate option for you."
  },
  {
    "name": "Colon Cleaning",
    "tag": "FROM OUR BROCHURE",
  ...
  {
    "name": "Magnetic Activation – Liver / Kidney",
    "tag": "FROM OUR BROCHURE",
    "detail": "Listed in the centre’s printed treatment catalogue. View rates and contact the team to discuss the appropriate option for you."
  },
  {
    "name": "Heliotherapy and Chromotherapy",
    "tag": "FROM OUR BROCHURE",
    "detail": "Listed in the centre’s printed treatment catalogue. View rates and contact the team to discuss the appropriate option for you."
  },
  {
...
export default function Home() {
  ...
  return <div className="wellness-home">
    <section className="wellness-hero" aria-labelledby="hero-title">
      ...
      <div className="hero-copy"><p className="wellness-eyebrow"><span className="tiny-sun" aria-hidden="true">✳</span> ROOTED IN NATURE. CENTRED ON YOU.</p><h1 id="hero-title">A gentler way<br/>to feel <em>like<br className="desktop-break"/> yourself.</em></h1><p className="hero-description">Natural healing. Holistic care. Lasting wellness.<br/>Thoughtful care for your everyday wellbeing,<br className="desktop-break"/> at Ahimsa Wellness Centre, Gurugram.</p><div className="hero-actions"><Link to="/book" className="wellness-button">Begin your journey <span aria-hidden="true">↗</span></Link><a href="#therapies" className="wellness-text-link">Explore therapies <span aria-hidden="true">↓</span></a></div><div className="hero-location"><span className="location-dot"/> WORLD PEACE CENTRE · GURUGRAM</div></div>
      <div className="hero-visual"><div className="hero-halo"/><NatureScene paused={paused || film || !!selected}/><figure className="founder-portrait"><img src={asset('dr-pandey')} alt="Dr S. N. Pandey" fetchpriority="high" width="900" height="1075"/><figcaption><span>EXPERIENCE THAT GUIDES US</span><strong>Dr S. N. Pandey</strong><p>Director · Naturopathy educator</p></figcaption></figure><div className="portrait-note"><span>Since</span><strong>1967</strong><span>A life devoted<br/>to natural care</span></div><button className="motion-toggle" onClick={()=>setPaused(!paused)} aria-pressed={paused}>{paused?'▶ Resume atmosphere':'Ⅱ Pause atmosphere'}</button></div>
    ...
    <section id="therapies" className="wellness-therapies section-wrap"><div className="section-kicker"><span className="wellness-eyebrow">02 / WAYS TO WELLBEING</span><span>A little more balance. A little more you.</span></div><div className="section-heading"><h2>Different paths.<br/>One <em>whole you.</em></h2><p>Explore our approaches to care.<br/>Begin with a conversation to find<br/>what is right for you.</p></div><div className="therapy-filters" role="group" aria-label="Filter therapies">{['All therapies','Naturopathy','Body therapies','Consultation'].map(f=><button key={f} onClick={()=>setFilter(f)} aria-pressed={filter===f}>{f}</button>)}</div><div className="therapy-grid" aria-live="polite">{visible.map((t)=><button className="therapy-card" key={t.name} onClick={()=>setSelected(t)} aria-label={`Explore ${t.name}`}><div className="therapy-image"><img src={asset(t.image)} srcSet={`${asset(`${t.image}-480`)} 480w, ${asset(t.image)} 1000w`} sizes="(max-width: 420px) 88vw, (max-width: 780px) 43vw, 29vw" alt={`${t.name} — illustrative therapy photograph`} loading="lazy" width="700" height="520"/><span className="therapy-open" aria-hidden="true">↗</span></div><div className="therapy-meta"><span>{t.tag}</span><span>{String(therapies.indexOf(t)+1).padStart(2,'0')}</span></div><h3>{t.name}</h3><p>{t.description}</p></button>)}</div><div className="additional-therapies"><p className="wellness-eyebrow">ALSO EXPLORE</p>{additionalTherapies.map(t=><button key={t.name} onClick={()=>setSelected(t)}>{t.name}<span aria-hidden="true">↗</span></button>)}</div><div className="therapy-footnote"><span>Therapy photographs are illustrative. Your care is individual.</span><Link to="/book" className="wellness-text-link">View availability & prices <span aria-hidden="true">↗</span></Link></div></section>

    <Packages />
    <section className="section-wrap brochure-care"><div className="section-heading"><h2>Care for your<br/><em>everyday life.</em></h2><p>A whole-person approach to body, mind and lifestyle.</p></div><div className="career-strip"><article><span>YOUR MEDICAL TEAM</span><h3>Dr S. N. Pandey</h3><p>Director. Former Vice Chancellor, Indira Gandhi Technological and Medical Sciences University, Ziro, Arunachal Pradesh.</p></article><article><span>MEDICAL OFFICER (Y/N)</span><h3>Dr Anushree Chauhan</h3><p>BNYS, PGD (Clinical Hypnosis).</p></article><article><span>PROGRAMMES</span><h3>Support with a plan</h3><p>Diabetes management, lifestyle intervention, stress and anxiety management, and yogic and naturopathic mental-health programmes. Contact the team to discuss scope and suitability.</p></article></div></section>
    ...
    <footer className="wellness-footer section-wrap"><div className="footer-top"><div><Brand/><p>A unit of Ahimsa Vishwa Bharti.<br/>A gentler approach to living well.</p></div><div><span className="wellness-eyebrow">FIND US</span><p>World Peace Centre, Sector 39<br/>Gurugram, Haryana 122022, India</p><a href="tel:+919873124147">+91 98731 24147</a><p>Daily: 8 AM–7 PM<br/>Treatments: 8 AM–1 PM &amp; 4–7 PM<br/>Consultation: 11 AM–1 PM &amp; 5–7 PM</p><a href="https://www.google.com/maps/search/?api=1&query=World+Peace+Centre+Sector+39+Gurugram" target="_blank" rel="noreferrer">Get directions ↗</a></div><div><span className="wellness-eyebrow">STAY CONNECTED</span><a href="https://www.instagram.com/ahimsawellnesscentre/" target="_blank" rel="noreferrer">Instagram ↗</a><a href="https://www.facebook.com/AhimsaAyurveda" target="_blank" rel="noreferrer">Facebook ↗</a><Link to="/login">My bookings ↗</Link></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Ahimsa Wellness Centre</span><span>NATUROPATHY · AYURVEDA · YOGA</span><Link to="/staff/login">Staff sign in ↗</Link></div></footer>
